export const i18n = {
  ru: {
    ...
    hero_title: 'Добро пожаловать в Vətən Restoran',
    ...
    reserve_message: 'Сообщение (опционально)',
    reserve_message_placeholder: 'Напишите дополнительные пожелания к брони',
    reserve_submit: 'Отправить',
    reserve_success: 'Ваша бронь принята и находится в обработке.',
  ...
  az: {
    ...
    reserve_phone_placeholder: '+994...',
    reserve_phone_invalid: 'Düzgün telefon nömrəsi daxil edin',
    reserve_message: 'Mesaj (istəyə görə)',
    reserve_message_placeholder: 'Bronla bağlı əlavə qeydlər yazın',
    reserve_submit: 'Göndər',
    reserve_success: 'Bronunuz qəbul edildi və hazırda emal olunur.',
  ...
  en: {
    ...
    hero_title: 'Welcome to Veten Restaurant',
    ...
    reserve_message: 'Message (optional)',
    reserve_message_placeholder: 'Add any notes for your reservation',
    reserve_submit: 'Submit',
    reserve_success: 'Your reservation has been accepted and is being processed.',
